...
PM_START_TEXT = """
Hello there, I'm [𝓬𝓵𝓮𝓿𝓮𝓻 𝓫𝓸𝔂](https://telegra.ph/file/c21a37a9866e9316cbf54.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add 𝓬𝓵𝓮𝓿𝓮𝓻 𝓫𝓸𝔂 to your group 💫", url="t.me/lasiyahh_clever_boy_bot?startgroup=true"
        ),
    ],
]
...
Support them  [lasiyahh](t.me/lasiyahh),[lasiyahh](t.me/lasiyahh),"""
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by Infinity_lasiyahh_bot.* "
            f"\n\n 🔥 Join [Infinity_lasiyahh_bot](https://t.me/Infinity_lasiyahh_bot) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](telegra.ph/file/c21a37a9866e9316cbf54.jpg)"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Ilasiyahhbott](https://t.me/lasiyahh_bott).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
